  ...
  return (
         <main className="dark:bg-pink-yyyy h-[80vh] text-[#341931] dark:text-white grid justify-items-center">
            ...
            <form action="" className="flex flex-col gap-y-5 py-2 ">
                ...
                <div className="flex">
                    <input type="text" name="username" id="username" placeholder="Enter your username" className="bg-transparent border-dark-purple dark:border-white border-b-2 placeholder-dark-purple dark:placeholder-white placeholder:text-sm" />
                    <BsPersonCircle className="text-lg relative right-6" />
                </div>
                <label htmlFor="password">Password</label>
                <div className="flex">
                    <input type="password" name="password" id="password" placeholder="Enter your password" className="bg-transparent border-dark-purple dark:border-white border-b-2 placeholder-dark-purple dark:placeholder-white placeholder:text-sm" />
